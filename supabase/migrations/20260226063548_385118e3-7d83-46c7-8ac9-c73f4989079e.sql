...
-- 1. Allow reopening registration (registration_closed → registration_open)
...
-- 3. Lock rosters on close, UNLOCK rosters when reopening registration
...
-- 4. Recapture RPC: re-syncs ALL members from the ORIGINAL squad
